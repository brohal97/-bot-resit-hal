...
function isElektrikRumahDetected(text) {
  const keyword = ["RICE COOKER", "COOKER", "PERIUK", "BLENDER", "MIXER", "JUICER", "CHOPPER", "TOASTER", "OVEN", "MICROWAVE",
    "STEAMER", "AIR FRYER", "FRYER", "KETTLE", "HOTPOT", "WATER HEATER", "HEATER", "AIR COOLER", "FAN", "KIPAS",
    "AIRCOND", "AIR CONDITIONER", "IRON", "SETTERIKA", "STEAM IRON", "DRYER", "VACUUM", "CLOTH DRYER", "WASHING MACHINE",
